...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $conn->prepare("UPDATE materias SET Materia = ?, AnioCursada = ?, Horas = ?, idTec = ?, Estado = ? WHERE id_Materia = ?");
        ...
        $stmt = $conn->prepare("SELECT Materia, AnioCursada, Horas, Estado, idTec FROM materias WHERE id_Materia = ?");
          ...
          <div class="row align-items-center">
            <div class="col-md-8 col-sm-8">
              <div class="md-form md-outline">
                <input id="idMateria" name="idMateria" type="text" class="form-control" value="<?php echo $id; ?>" readonly required>
