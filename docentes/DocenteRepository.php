...
class DocenteRepository
{
    ...
    {
        try {
            $query = $this->conexiones->prepare("SELECT id_Persona,idUsuario, nombre, apellido FROM personas WHERE codRol = 5 AND Estado = 1;");
            $query->execute();
    ...
    {
        // Implementar la lógica para obtener un docente por ID
    }

    public function createDocente($data)
    {
        // Implementar la lógica para crear un nuevo docente
    }

    public function updateDocente($id, $data)
    {
        // Implementar la lógica para actualizar un docente existente
    }
}