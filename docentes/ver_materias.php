...
<head>
    ...
    <script>
        ...
        function borrarMateria(element) {
            window.location.href = "materia_eliminar.php?id=" + element.id;
        }
    </script>
</head>
          ...
          <div class="row align-items-center">
            <div class="col-md-8 col-sm-8">
              <div class="md-form md-outline">
                <input id="idTecnicatura" name="idTecnicatura" type="text" class="form-control" value="<?php echo $id_Tecnicatura; ?>" readonly>
                <label for="idTecnicatura" class="active">ID Tecnicatura</label>
              </div>
            </div>
