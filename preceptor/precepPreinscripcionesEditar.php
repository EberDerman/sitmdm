    ...
    <div class="card">
      <div class="card-body">
        <form id="formulario" method="post"
          action="precepPreinscripcionActualizar.php?id_estudiante=<?php echo urlencode($_GET['id_estudiante']); ?>&id_Tecnicatura=<?php echo urlencode($_GET['id_Tecnicatura']); ?>">
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-secondary"
              href='precepPreinscripcionesVer.php?id_estudiante=<?= $_GET["id_estudiante"] ?>&id_Tecnicatura=<?= $_GET["id_Tecnicatura"] ?>&nombreTec=<?= $_GET["nombreTec"] ?>&Ciclo=<?= $_GET["Ciclo"] ?>'">
              VOLVER
            </a>
          </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <select id="id_Tecnicatura" class="form-select" name="id_Tecnicatura" required>
                      <option value="" disabled>Seleccione una Tecnicatura</option>
                      <?php
                      // Verificamos si el estudiante tiene asignada una tecnicatura
                      $selectedTecnicaturaId = isset($estudiante_tecnicatura['id_Tecnicatura']) ? $estudiante_tecnicatura['id_Tecnicatura'] : '';

                      // Recorremos todas las tecnicaturas disponibles para inscripciones
                      foreach ($listaTecnicaturasInscripcion as $tecnicatura) {
                        ...
                        // Verificamos si esta tecnicatura es la que está asignada al estudiante
                        $selected = ($selectedTecnicaturaId == $id_Tecnicatura) ? 'selected' : '';

                        ?>
                        <option value="<?= $id_Tecnicatura ?>" <?= $selected ?>><?= htmlspecialchars($nombreTec) ?>
                        </option>
                        <?php
                      }
                      ?>
                ...
                <section>
                  ...
                  <div class="argentina">
                    ...
                    <div class="bsas">
                      ...
                      <input type="text" class="form-control" id="codigo_postal" placeholder="Codigo Postal" name="codigo_postal"
                        value="<?= htmlspecialchars($estudiante['codigo_postal']) ?>" required pattern="[0-9]+">
                    </div>
                    <div class="mb-3">
