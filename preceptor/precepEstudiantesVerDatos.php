          ...
          <section>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="apellido" placeholder="Apellido/s" name="apellido"
                      value="<?= htmlspecialchars($estudiante['apellido']) ?>" disabled pattern="[A-Za-z\s]+"
                      title="Solo letras y espacios">
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="nombre" class="form-label">Nombre/s:</label>
                    <input type="text" class="form-control" id="nombre" placeholder="Nombre/s" name="nombre"
                      value="<?= htmlspecialchars($estudiante['nombre']) ?>" disabled pattern="[A-Za-z\s]+"
                      title="Solo letras y espacios">
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="telefono" class="form-label">Teléfono:</label>
                    <input type="tel" class="form-control" id="telefono" placeholder="Teléfono" name="telefono"
                      value="<?= htmlspecialchars($estudiante['telefono']) ?>" disabled pattern="[0-9]{10}"
              ...
              <section>
                ...
                <div class="mb-3">
                  ...
                  <select id="dniSelect" class="form-select" name="posee_dni" disabled>
                ...
                <div class="dni">
                  <div class="mb-3">
                    ...
                    <input id="dniNumber" type="text" class="form-control" placeholder="********" name="dni_numero"
                      value="<?= htmlspecialchars($estudiante['dni_numero']) ?>" disabled pattern="[0-9]{8}">
                  </div>
                  <div class="mb-3">
                    <label for="cuilNumber" class="form-label">CUIL:</label>
                    <input id="cuilNumber" type="text" class="form-control" placeholder="***********" name="cuil"
                      value="<?= htmlspecialchars($estudiante['cuil']) ?>" disabled pattern="[0-9]{11}">
                  </div>
                </div>
                <div class="dniNo">
                  <h5>¿Posee certificado de preinscripción (CPI)?</h5>
                  <div class="form-check">
                    <input class="form-check-input" type="radio" id="cpiSi" value="SI" name="tiene_cpi" disabled>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tipo_documento_extranjero"
                      placeholder="Tipo de documento" name="tipo_documento_extranjero" disabled pattern="[A-Za-z\s]+">
                  </div>
                  <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="numero_documento_extranjero" placeholder="N°"
                      name="numero_documento_extranjero" disabled>
                  </div>
                </div>
              </section>
              ...
              <section>
                <div class="mb-3">
                  ...
                  <select id="identidadGenero" class="form-select" name="identidad_genero" disabled>
              ...
              <section>
                <div class="mb-3">
                  ...
                  <select id="pais_select" class="form-select" name="lugar_nacimiento" disabled>
                    <option value="" disabled selected>Seleccione una opción</option>
                ...
                <div class="exterior">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="especificar_pais" placeholder="Especificar país"
                      name="especificar_pais" disabled pattern="[A-Za-z\s]+">
                  </div>
                </div>
                <div class="argentina">
                  <div class="mb-3">
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      function toggleFields() {
        ...
        if (paisSelect.value === "1") { // Argentina
          ...
          especificarPaisField.disabled = false;
          argentinaFields.querySelectorAll("input, select").forEach(input => input.disabled = true);
        } else if (paisSelect.value === "2") { // Extranjero
          argentinaFields.style.display = "none";
          exteriorFields.style.display = "block";
          especificarPaisField.disabled = true;
          argentinaFields.querySelectorAll("input, select").forEach(input => input.disabled = false);
