...
<script>
    ...
    ORDER BY m.AnioCursada ASC";
        ...
        });                                 SUPERADO!!!! NO COLAPSABA AL VOLVER A PRESIONAR VER
        ...
        */
        ...
        /*function generarHTML(materias) {
            return Object.values(materias).map((materiaData) => {
                ...
                const porcentajeAsistencia = calcularPorcentajeAsistencia(materiaData.horas_dadas, materiaData.horas_asistidas);
                ...
                return `
                    <div class="card mb-3">
                        ...
                        <div id="collapse${cardId}" class="collapse" aria-labelledby="heading${cardId}">
                            <div class="card-body">
                                ...
                                <hr>
                                 <p><strong>Porcentaje de asistencia:</strong> ${calcularPorcentajeAsistencia(materiaData.horasDadas, materiaData.horasAsistidas)}%</p>
                                <hr>
                    ...
                    </div>             SUPERADO!!!!! NO ANDABA EL % DE ASISTENCIA
                `;
            }).join('');
        }*/
        function generarHTML(materias) {
