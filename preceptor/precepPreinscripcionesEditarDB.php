...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($check_stmt->num_rows > 0) {
        ...
        $stmt = $conexion->prepare("INSERT INTO estudiantes (numero_establecimiento, apellido, nombre, telefono, email, posee_dni, dni_numero, cuil, tiene_cpi, documento_extranjero, tipo_documento_extranjero, numero_documento_extranjero, identidad_genero, lugar_nacimiento, especificar_pais, provincia, ciudad, codigo_postal, calle, localidad, distrito, numero, piso, departamento) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
